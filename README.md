...
Этот репозиторий публично раскрывает только исходный код Android-клиента **Levik VPN** (`levik_vpn_android/`) и необходимые для него CI/release-материалы. Он опубликован для прозрачности и независимого изучения кода. Изменения принимает и выпускает только владелец проекта; публичные Issues и Pull Requests не используются.
