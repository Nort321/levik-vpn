		...
		go func(workerIndex, wid int) {
			...
			for {
				...
				configDelivered, sessErr := RunSession(ctx, tp, peer, d, localPort,
					getConf, cc, requireConfig, onConfigDelivered, wid, attempt, &credsSnapshot,
...
type TurnParams struct {
	...
	WrapV2ID    *[levikWrapIDLen]byte // Levik WRAP v2 credential selector; nil uses legacy v15.
}
